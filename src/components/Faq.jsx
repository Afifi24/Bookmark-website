  ...
  return (
    <div className='py-20'>
         <div className='flex flex-col items-center gap-4 text-center'>
            <h1 className='font-bold text-2xl md:text-3xl'>Frequently Asked Questions</h1>
            <p className='md:max-w-md max max-w-sm text-sm md:text-[16px] text-gray-400 leading-[27px]'>Here are some of our FAQs. if you have any other questions you'd like answered please feel free to email us.</p>
         </div>
         <div id='faq' className='flex items-center flex-col justify-center mt-10'>
                  ...
                  <button className='px-4 mt-10 py-2  md:flex bg-blue-500 rounded-md text-white '>More Info</button>
         </div>
